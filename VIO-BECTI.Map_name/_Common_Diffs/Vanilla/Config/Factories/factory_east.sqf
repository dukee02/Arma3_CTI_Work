...
if (isNil "_priorUnits") then { 
	...
	if(CTI_CAMO_ACTIVATION == 1) then {
		missionNamespace setVariable [format["CTI_%1Commander", _tag], format["%1O_T_Soldier_TL_F", _sid]];
		missionNamespace setVariable [format["CTI_%1Worker", _tag], format["%1O_T_Soldier_unarmed_F", _sid]];

		missionNamespace setVariable [format["CTI_%1Diver", _tag], format["%1O_T_Soldier_F", _sid]];
		missionNamespace setVariable [format["CTI_%1Soldier", _tag], format["%1O_T_Soldier_F", _sid]];
		missionNamespace setVariable [format["CTI_%1Crew", _tag], format["%1O_T_Crew_F", _sid]];
		missionNamespace setVariable [format["CTI_%1Pilot", _tag], format["%1O_T_Pilot_F", _sid]];
		missionNamespace setVariable [format["CTI_%1Static", _tag], format["%1O_T_Soldier_F", _sid]];

		//In some Mods we have special Town camo we can use
		missionNamespace setVariable [format["CTI_%1TownLeader", _tag], format["%1O_T_Soldier_TL_F", _sid]];
		missionNamespace setVariable [format["CTI_%1TownSoldier", _tag], format["%1O_T_Soldier_F", _sid]];
		missionNamespace setVariable [format["CTI_%1TownCrew", _tag], format["%1O_T_Crew_F", _sid]];
		...
		missionNamespace setVariable [format["CTI_%1Commander", _tag], format["%1O_Soldier_TL_F", _sid]];
		missionNamespace setVariable [format["CTI_%1Worker", _tag], format["%1O_Soldier_unarmed_F", _sid]];

		missionNamespace setVariable [format["CTI_%1Diver", _tag], format["%1O_Soldier_lite_F", _sid]];
		missionNamespace setVariable [format["CTI_%1Soldier", _tag], format["%1O_Soldier_F", _sid]];
		missionNamespace setVariable [format["CTI_%1Crew", _tag], format["%1O_crew_F", _sid]];
		missionNamespace setVariable [format["CTI_%1Pilot", _tag], format["%1O_Pilot_F", _sid]];
		missionNamespace setVariable [format["CTI_%1Static", _tag], format["%1O_Soldier_F", _sid]];
	...
	if (CTI_Log_Level >= CTI_Log_Debug) then {
		["VIOC_DEBUG", "FILE: common\config\factories\factory_east.sqf", format["Commander: <%1>", missionNamespace getVariable format["CTI_%1Commander", _tag]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_east.sqf", format["Worker: <%1>", missionNamespace getVariable format["CTI_%1Worker", _tag]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_east.sqf", format["Diver: <%1>", missionNamespace getVariable format["CTI_%1Diver", _tag]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_east.sqf", format["Soldier: <%1>", missionNamespace getVariable format["CTI_%1Soldier", _tag]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_east.sqf", format["Crew: <%1>", missionNamespace getVariable format["CTI_%1Crew", _tag]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_east.sqf", format["Pilot: <%1>", missionNamespace getVariable format["CTI_%1Pilot", _tag]]] call CTI_CO_FNC_Log;
		["VIOC_DEBUG", "FILE: common\config\factories\factory_east.sqf", format["Static: <%1>", missionNamespace getVariable format["CTI_%1Static", _tag]]] call CTI_CO_FNC_Log;
	};
};
