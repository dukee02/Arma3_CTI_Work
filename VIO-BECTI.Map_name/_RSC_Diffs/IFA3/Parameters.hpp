class Params {
	...
	class CTI_GUER_TOWNS {
		...
		values[] = {-1,0,1,2};
		texts[] = {"3rd Party (needs one Side on GUER or set 50:50 at townsmode)","FFI - very easy [IFA3 / SPE]","Polish Units - easy [IFA3 needed]","Zombies [one of Ryan|Max|WBK Zombie Mod]"};
		default = -1;
	};
